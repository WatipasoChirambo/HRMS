# Generated by Django 3.2.8 on 2021-11-29 12:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(blank=True, choices=[('MSCE', 'MSCE'), ('Diploma', 'Diploma'), ('Bsc Degree', 'Bsc Degree'), ('Masters', 'Masters')], max_length=120, null=True)),
                ('sex', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], max_length=120, null=True)),
                ('nationality', models.CharField(blank=True, choices=[('Malawian', 'Malawian'), ('Kenyan', 'Kenyan'), ('Zimbawean', 'Zimbawean')], max_length=120, null=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Completed', 'Completed'), ('pending', 'pending'), ('Not Completed', 'Not Completed')], max_length=120, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(related_name='project_Files', to='home.ProjectFile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(related_name='meeting_Files', to='home.MeetingFile')),
                ...
                ('notes_taker', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='note_taker', to=settings.AUTH_USER_MODEL)),
